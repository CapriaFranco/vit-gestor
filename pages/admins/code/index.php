<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['generate'])) {
        ...
        if ($stmt->execute()) {
            ...
            header('Location: ' . buildPath($base_path, 'a/codes'));
            exit;
        } else {
...
<head>
    ...
    <title>Códigos - Admin VIT 2025</title>
    ...
    <main>
        <div class="form admin-dashboard">
            ...
            <div class="admin-nav-buttons">
                <a href="<?php echo buildPath($base_path, 'a/dash'); ?>" class="btn btn-secondary">← Dashboard</a>
                <a href="<?php echo buildPath($base_path, 'a/teams'); ?>" class="btn btn-secondary">Editar Equipos</a>
            </div>

            <!-- Generate button moved above the code display -->
            ...
            <!-- Consolidated message and code display -->
